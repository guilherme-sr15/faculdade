...
select nome from medicamento where codigo IN (select distinct medicamento from receita) order by nome;create database atendimento;
...
insert into paciente (cpf, nome, data_n, idade) values (123, 'Joao Carlos', '1999-01-10', 14);
insert into paciente (cpf, nome, data_n, idade) values (456, 'Maria Clara', '2000-02-20', 13);
insert into paciente (cpf, nome, data_n, idade) values (789, 'Ana Flavia', '1993-05-05', 20);

insert into medico (crm, nome, especialidade, data_n) values (555, 'Mauro', 'Ortopedista', '1980-10-10');
insert into medico (crm, nome, especialidade, data_n) values (777, 'Eduardo', 'Cardiologista', '1988-03-03');
insert into medico (crm, nome, especialidade, data_n) values (999, 'Ronaldo', 'Ortopedista', '1970-02-20');

insert into consulta (paciente, medico, data, horario, local) values (123, 555, '2012-06-20', '13:00:00', 'Sala A');
insert into consulta (paciente, medico, data, horario, local) values (123, 777, '2012-06-22', '16:00:00', 'Sala A');
insert into consulta (paciente, medico, data, horario, local) values (789, 555, '2012-06-20', '17:30:00', 'Sala B');

insert into medicamento (codigo, nome, ativo, validade) values (001, 'Descon Gotas', 'Paracetamol', '2016-10-10');
insert into medicamento (codigo, nome, ativo, validade) values (002, 'Cefalium', 'Paracetamol', '2012-05-05');
insert into medicamento (codigo, nome, ativo, validade) values (003, 'Asmapen', 'Aminofilina', '2014-12-01');

insert into receita (medicamento, paciente, medico, data, posologia) values (001, 123, 555, '2012-06-20', '20 gotas 3x ao dia');
insert into receita (medicamento, paciente, medico, data, posologia) values (003, 123, 555, '2012-06-20', '1 comprimido a cada 12 horas');
insert into receita (medicamento, paciente, medico, data, posologia) values (001, 789, 555, '2012-06-20', '10 gotas pela manha');
