...
public class Show extends JInternalFrame implements ActionListener{
    ...
    private void adicionarComponentes() {
        addComponents(scrollDados, 0,1, 2,1,GridBagConstraints.WEST);
        addComponents(buttonShow, 2,1,1,4, GridBagConstraints.EAST);
        add(panel);
    }
    
    private void addComponents(Component comp, int line, int column, int width, int height, int position){
