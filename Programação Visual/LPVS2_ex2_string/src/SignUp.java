...
public class SignUp extends JInternalFrame implements ActionListener {
    ...
    private void adicionarComponentes() {
        addComponent(labelNome, 0, 0, GridBagConstraints.EAST);
        addComponent(fieldNome, 0, 1, GridBagConstraints.WEST);
        addComponent(labelAge,1,0, GridBagConstraints.EAST);
        addComponent(fieldAge,1,1, GridBagConstraints.WEST);
        addComponent(buttonInserir,2,1,GridBagConstraints.EAST);
        add(panel);
    }
